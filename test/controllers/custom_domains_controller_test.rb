...
class CustomDomainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create custom_domain" do
    assert_difference('CustomDomain.count') do
      post custom_domains_url, params: { custom_domain: { name: @custom_domain.name, redirect_url: @custom_domain.redirect_url } }
    end
  ...
  test "should update custom_domain" do
    patch custom_domain_url(@custom_domain), params: { custom_domain: { name: @custom_domain.name, redirect_url: @custom_domain.redirect_url } }
